<?php	
	...
	if (empty($_POST['mod_name'])) {
		...
		$tipousuario=intval($_POST['mod_tipousuario']);
		$id=$_POST['mod_id'];

		$sql="UPDATE user SET name=\"$name\", email=\"$email\",is_active=$status,tipousuario=\"$tipousuario\" WHERE id=$id";
