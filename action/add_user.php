<?php	
	...
	if (empty($_POST['name'])) {
		...
		if(isset($_POST["is_admin"])){$is_admin=1;}
			...
			$sql="INSERT INTO user ( name, password, email, profile_pic, is_active, tipousuario, created_at) VALUES ('$end_name','$password','$email','$profile_pic',$status, $tipoUsuario,'$created_at')";
