            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                <?php 
                        while ($r=mysqli_fetch_array($query)) {
                            ...
                            //Agregado para que muestre que tipo de usuario tiene al querer actualizar
                            $tipousuario=$r['tipousuario'];
                                if ($tipousuario==1){$tipousuario_f="Administrador";}else {$tipousuario_f="Usuario";}
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $email;?>" id="email<?php echo $id;?>">
                     ...
                     <input type="hidden" value="<?php echo $tipousuario;?>" id="tipousuario<?php echo $id;?>">

                    <tr class="even pointer">
                        <td><?php echo $name;?></td>
                        <td><?php echo $email;?></td>
                        <td ><?php echo $status_f; ?></td>
                        <td ><?php echo $tipousuario_f; ?></td>
